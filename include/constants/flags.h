...
#define FLAG_POKE_REPEL      0x20 // Poke Repel
...
#define FLAG_SYS_PC_FROM_POKENAV             0xE9 // Unused Flag
...
#define FLAG_RECEIVED_TM51 0x264 // Received Bug Bite TM
...
#define FLAG_SUPPRESS_SPEAKER_NAME                  (SYSTEM_FLAGS + 0x23) // Suppress speaker name
