...
static const u8 sText_MoveEvaporatedInTheHarshHeat[] = _("The Water-type attack evaporated\nin the harsh heat!");
...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_MOVEEVAPORATEDINTHEHARSHHEAT - BATTLESTRINGS_TABLE_START] = sText_MoveEvaporatedInTheHarshHeat,
