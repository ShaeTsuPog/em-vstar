...
// TMs/HMs. They don't have a set flingPower, as that's handled by GetFlingPowerFromItemId.
    ...
    [ITEM_TM54_SWORDS_DANCE] =
    {
        .name = _("TM54"),
        .itemId = ITEM_TM54_SWORDS_DANCE,
        .price = 3000,
...
// Misc. Key Items
    ...
    {
        .name = _("PokéRepel"),
        .itemId = ITEM_POKE_REPEL,
        .price = 20000,
        .description = sPokeRepelDesc,
        .importance = 1,
        .registrability = TRUE,
        .pocket = POCKET_KEY_ITEMS,
        .type = ITEM_USE_BAG_MENU,
        .fieldUseFunc = ItemUseOutOfBattle_PokeRepel,
    },
