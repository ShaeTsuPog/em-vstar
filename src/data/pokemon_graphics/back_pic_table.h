const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(GENGAR_MEGA_X, gMonBackPic_GengarMega),
    SPECIES_SPRITE(GENGAR_MEGA_Y, gMonBackPic_GengarMegaY),
    ...
    SPECIES_SPRITE(RHYPERIOR_MEGA, gMonBackPic_RhyperiorMega),
