...
const struct MonCoords gMonBackPicCoords[] =
{
    ...
    [SPECIES_GENGAR_MEGA_X]                = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    [SPECIES_GENGAR_MEGA_Y]                = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  6 },
    [SPECIES_KINGLER_MEGA]                 = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  6 },
    ...
    [SPECIES_TYPHLOSION_MEGA]              = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    ...
    [SPECIES_FLYGON_MEGA]                  = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
    ...
    [SPECIES_RHYPERIOR_MEGA]               = { .size = MON_COORDS_SIZE(64, 64), .y_offset =  0 },
