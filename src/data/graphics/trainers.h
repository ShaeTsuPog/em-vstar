...
const u32 gTrainerFrontPic_LeaderBoris[] = INCBIN_U32("graphics/trainers/front_pics/leader_boris.4bpp.lz");
const u32 gTrainerPalette_LeaderBoris[] = INCBIN_U32("graphics/trainers/palettes/leader_boris.gbapal.lz");
