...
static const struct TrainerMonCustomized sParty_Boris1[] =
{
    {
        .species = SPECIES_SHUCKLE,
        .ball = ITEM_NET_BALL,
        .ability = ABILITY_JUICE_MAKER,
        .friendship = 255,
        ...
        .lvl = 15,
        .moves = {MOVE_STICKY_WEB, MOVE_BULLDOZE, MOVE_ROCK_TOMB, MOVE_INFESTATION},
    ...
    },
    {
        ...
        .ev = TRAINER_PARTY_EVS(0, 0, 0, 0, 0, 0),
        .lvl = 15,
        .moves = {MOVE_SWORDS_DANCE, MOVE_POUNCE, MOVE_WING_ATTACK, MOVE_LOW_SWEEP},
    ...
    },
    {
        ...
        .ev = TRAINER_PARTY_EVS(0, 0, 0, 0, 0, 0),
        .lvl = 15,
        .moves = {MOVE_STUN_SPORE, MOVE_ICY_WIND, MOVE_STRUGGLE_BUG, MOVE_FAIRY_WIND},
        .nature = TRAINER_PARTY_NATURE(NATURE_TIMID),
    },
    {
        .species = SPECIES_BEEDRILL,
        .ball = ITEM_NET_BALL,
        .ability = ABILITY_HIVE_TACTICS,
        .friendship = 255,
        .gender = TRAINER_MON_MALE,
        ...
        .ev = TRAINER_PARTY_EVS(0, 0, 0, 0, 0, 0),
        .lvl = 15,
        .moves = {MOVE_PROTECT, MOVE_BUG_BITE, MOVE_POISON_JAB, MOVE_CUT},
        .nature = TRAINER_PARTY_NATURE(NATURE_ADAMANT),
    },
    {
        ...
        .ev = TRAINER_PARTY_EVS(0, 0, 0, 0, 0, 0),
        .lvl = 15,
        .moves = {MOVE_BUG_BITE, MOVE_METAL_CLAW, MOVE_CRUNCH, MOVE_SHADOW_CLAW},
    ...
    },
    {
        ...
        .ev = TRAINER_PARTY_EVS(0, 0, 0, 0, 0, 0),
        .lvl = 15,
        .moves = {MOVE_PROTECT, MOVE_BRICK_BREAK, MOVE_NIGHT_SLASH, MOVE_ROCK_TOMB},
        .nature = TRAINER_PARTY_NATURE(NATURE_ADAMANT),
    }
};

static const struct TrainerMonCustomized sParty_Alexandra1[] =
{
    {
        .species = SPECIES_GOLEM,
        .ball = ITEM_HEAVY_BALL,
        .ability = ABILITY_WEATHERING,
        .friendship = 255,
        ...
        .ev = TRAINER_PARTY_EVS(0, 0, 0, 0, 0, 0),
        .lvl = 25,
        .moves = {MOVE_BULLDOZE, MOVE_SHORE_UP, MOVE_ROCK_SLIDE, MOVE_HEAT_CRASH},
        .nature = TRAINER_PARTY_NATURE(NATURE_IMPISH),
    },
    {
        .species = SPECIES_DUGTRIO_ALOLAN,
        .ball = ITEM_HEAVY_BALL,
        .ability = ABILITY_TRIPLICATE,
        .friendship = 255,
        .gender = TRAINER_MON_FEMALE,
        ...
        .ev = TRAINER_PARTY_EVS(0, 0, 0, 0, 0, 0),
        .lvl = 24,
        .moves = {MOVE_IRON_HEAD, MOVE_BULLDOZE, MOVE_TRI_ATTACK, MOVE_SUCKER_PUNCH},
        .nature = TRAINER_PARTY_NATURE(NATURE_JOLLY),
    },
    {
        .species = SPECIES_QUAGSIRE, // SPECIES_CLODSIRE
        .ball = ITEM_HEAVY_BALL,
        ...
        .ev = TRAINER_PARTY_EVS(0, 0, 0, 0, 0, 0),
        .lvl = 24,
        .moves = {MOVE_TOXIC_SPIKES, MOVE_RECOVER, MOVE_LIQUIDATION, MOVE_POISON_JAB},
    ...
    },
    {
        ...
        .ev = TRAINER_PARTY_EVS(0, 0, 0, 0, 0, 0),
        .lvl = 24,
        .moves = {MOVE_DRILL_RUN, MOVE_FURY_CUTTER, MOVE_AERIAL_ACE, MOVE_ROCK_SMASH},
    },
    {
        .species = SPECIES_SKARMORY,
        .ball = ITEM_HEAVY_BALL,
        ...
        .ev = TRAINER_PARTY_EVS(0, 0, 0, 0, 0, 0),
        .lvl = 24,
        .moves = {MOVE_DUAL_WINGBEAT, MOVE_ROOST, MOVE_WHIRLWIND, MOVE_TAUNT},
    },
    {
        ...
        .friendship = 255,
        .gender = TRAINER_MON_FEMALE,
        .heldItem = ITEM_DRY_ROCK,
        .isShiny = FALSE,
        .iv = TRAINER_PARTY_IVS(31, 31, 31, 31, 31, 31),
        .ev = TRAINER_PARTY_EVS(0, 0, 0, 0, 0, 0),
        .lvl = 25,
        .moves = {MOVE_SHOCK_WAVE, MOVE_ENERGY_BALL, MOVE_POWER_GEM, MOVE_ICE_BEAM},
    }
};
