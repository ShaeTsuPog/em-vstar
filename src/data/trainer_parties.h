...
{
    {
        ...
        .lvl = 15,
        .moves = {MOVE_STICKY_WEB, MOVE_BULLDOZE, MOVE_ROCK_THROW, MOVE_INFESTATION},
...
static const struct TrainerMonCustomized sParty_Alexandra1[] =
{
    ...
    },
    {
        ...
        .ev = TRAINER_PARTY_EVS(0, 0, 0, 0, 0, 0),
        .lvl = 24,
        .moves = {MOVE_TOXIC_SPIKES, MOVE_RECOVER, MOVE_BULLDOZE, MOVE_POISON_TAIL},
    ...
    },
    {
        ...
        .ev = TRAINER_PARTY_EVS(0, 0, 0, 0, 0, 0),
        .lvl = 24,
        .moves = {MOVE_DRILL_RUN, MOVE_FURY_CUTTER, MOVE_POISON_JAB, MOVE_IRON_TAIL},
    },
    {
        .species = SPECIES_SKARMORY,
        .ball = ITEM_HEAVY_BALL,
        ...
        .ev = TRAINER_PARTY_EVS(0, 0, 0, 0, 0, 0),
        .lvl = 24,
        .moves = {MOVE_DUAL_WINGBEAT, MOVE_ROOST, MOVE_WHIRLWIND, MOVE_SPIKES},
    },
    {
